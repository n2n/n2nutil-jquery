...
use n2nn2nutil\jquery\datepicker\DatePickerUtils;
...
class DatePickerHtmlBuilder {
	...
	private function requireScripts() {
		...
		$html->meta()->addJs('datepicker/js/datePicker.js', 'n2nn2nutil\jquery', false, false, null, HtmlBuilderMeta::TARGET_BODY_END);
		$html->meta()->addCss('datepicker/css/datePicker.css', 'screen', 'n2nn2nutil\jquery');
	}
}